...
int main ()
{
    ...
    while(n--){
        ...
        if(ans1==0&&ans2!=0){
            cout<<2<<endl;
            cout<<"UD"<<endl;continue;
        }
        if(ans2==0&&ans1!=0){
            cout<<2<<endl;
            cout<<"LR"<<endl;continue;
        }
        cout<<ans1*2+ans2*2<<endl;
        for(int i=0;i<ans1;i++)cout<<'L';
        for(int i=0;i<ans2;i++)cout<<'D';
        for(int i=0;i<ans1;i++)cout<<'R';
        for(int i=0;i<ans2;i++)cout<<'U';
        cout<<endl;
    }
