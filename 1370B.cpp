...
int main ()
{
    ...
    while(t--){
        ...
        if(odd.size()==0){
            ...
            if(sum%2){
                for(int i=1;i<odd.size();i+=2)cout<<odd[i].second<<" "<<odd[i+1].second<<endl;
                for(int i=1;i<even.size();i+=2)cout<<even[i].second<<" "<<even[i+1].second<<endl;
            }
            else {

                for(int i=2;i<odd.size();i+=2)cout<<odd[i].second<<" "<<odd[i+1].second<<endl;
                for(int i=0;i<even.size();i+=2)cout<<even[i].second<<" "<<even[i+1].second<<endl;
            }
        }
    }
